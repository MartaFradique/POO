...
public class principal {
    public static void main(String[] args) {
        Retangulo r = new Retangulo(6,3,"azul");
        Retangulo re = new Retangulo(7,8,"red");
        Triangulo t = new Triangulo(3, 4, 5,"black");
        Triangulo tr = new Triangulo(3, 4, 5,"green");
        Circulo c = new Circulo(2, 0, 3,"yellow");
        Circulo ci = new Circulo(2, 0, 2,"pink");
